...
ab_content = ab_content.replace('probeTT, storeTT', 'probeTT, probeTTFast, unpackDataFast, storeTT')
...
q_content = q_content.replace('probeTT, storeTT', 'probeTT, probeTTFast, unpackDataFast, storeTT')
