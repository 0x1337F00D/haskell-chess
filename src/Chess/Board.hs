...
instance MoveGenerator 'NotInCheck where
    legalMovesValidated (ValidatedBoard (Board b gs _)) = map LegalMove $ U.toList $ MoveGen.legalGenMovesNotInCheck b gs
    captureMovesValidated (ValidatedBoard (Board b gs _)) = map LegalMove $ U.toList $ MoveGen.legalGenCapturesNotInCheck b gs
    legalQuietsValidated (ValidatedBoard (Board b gs _)) = map LegalMove $ U.toList $ MoveGen.legalGenQuietsNotInCheck b gs
    legalPromotionsValidated (ValidatedBoard (Board b gs _)) = map LegalMove $ U.toList $ MoveGen.legalGenPromotionsNotInCheck b gs
